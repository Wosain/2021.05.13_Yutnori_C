...
void CBoardDlg::OnBnClickedButton1()
{
	...
	{
		CBitmap bmpBack3; bmpBack3.LoadBitmapA(IDB_BITMAP3);	//도
	...
	{
		CBitmap bmpBack4; bmpBack4.LoadBitmapA(IDB_BITMAP4);		//개
	...
	{
		CBitmap bmpBack5; bmpBack5.LoadBitmapA(IDB_BITMAP5);		//걸
	...
	{
		CBitmap bmpBack6; bmpBack6.LoadBitmapA(IDB_BITMAP6);		//윷
	...
	{
		CBitmap bmpBack7; bmpBack7.LoadBitmapA(IDB_BITMAP7);		//모
...
void CBoardDlg::OnPaint()
{
	...
	else 
	{
		CDC* pDC = GetDC();
		CClientDC dc(this);
		CBitmap bmpBack; bmpBack.LoadBitmapA(IDB_BITMAP2);
